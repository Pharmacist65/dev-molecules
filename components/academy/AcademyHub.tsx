...
const copy = {
  tr: {
    ...
    synthesisShortcutMeta: "{records} katalog kimliği · taslaklar pending, incelenmiş rotalar ayrı",
  ...
  en: {
    ...
    synthesisShortcutMeta: "{records} catalog identities · drafts pending, reviewed routes separate",
