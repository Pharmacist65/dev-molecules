...
const copy = {
  tr: {
    eyebrow: "AKADEMİ · ÖĞRENME HARİTASI",
    title: "Yapıyı okumaktan kanıtı savunmaya.",
    description: "Sekiz modüllük yol, çalışan dersleri bilimsel kapsam kapılarından ayırır. İlerleme yalnız gerçek etkinliklerden hesaplanır.",
    mapAria: "Sekiz modüllük Akademi öğrenme haritası",
    recommended: "Önerilen sonraki modül",
    openRecommended: "Devam et",
    available: "Hazır",
    coverageDependent: "Kapsama bağlı",
    planned: "Planlandı",
    duration: "Tahmini süre",
    minutes: "dk",
    completion: "Tamamlanma",
    notTracked: "Henüz izlenmiyor",
  ...
  en: {
    eyebrow: "ACADEMY · LEARNING MAP",
    title: "From reading structure to defending evidence.",
    description: "The eight-module path separates working lessons from scientific coverage gates. Progress is calculated only from real activities.",
    mapAria: "Eight-module Academy learning map",
    recommended: "Recommended next module",
    openRecommended: "Continue",
    available: "Available",
    coverageDependent: "Coverage dependent",
    planned: "Planned",
