...
Explore loads a deterministic, stratified resident metadata window of at most 40 generated records and leaves structure assets lazy. Full-index search and paging work across all 1,552 records; selecting a result resolves one shard/entity and one requested structure through bounded caches instead of raising the resident limit.
