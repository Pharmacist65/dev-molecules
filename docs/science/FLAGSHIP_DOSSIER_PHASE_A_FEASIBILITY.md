...
| Synthesis | A private candidate/draft inventory exists, but molecule-to-source mappings, route type, materials and transformations are withheld | Pending / private | Exact identity, source locator, scientific review and reuse-rights gates must pass before any detail is published |
...
| Learning | Identify groups/scaffold; distinguish parent/HCl; map antagonism; build the systematic name | Derived from reviewed claims | A synthesis task remains unavailable until a reviewed and reuse-eligible projection exists; learning copy cannot become additional scientific claims |
...
- Synthesis detail: **private and pending**; do not publish route variants or source mappings before review and rights eligibility.
...
| Learning | Mark diarylpyrazole/sulfonamide/CF3; distinguish NSAID, inhibitor family and scaffold; bind assay context; practise nomenclature locants | Derived from reviewed claims | A synthesis task remains unavailable until a reviewed and reuse-eligible projection exists; learning answer keys require review |
...
| Learning | Mark stereogenic sulfur; trace enteric journey/acid activation; distinguish sulfide and sulfoxide; investigate the source-dependent methoxy locant | Derived from reviewed claims | A synthesis task remains unavailable until a reviewed and reuse-eligible projection exists; answer keys disclose the nomenclature conflict and computed-3D limitation |
