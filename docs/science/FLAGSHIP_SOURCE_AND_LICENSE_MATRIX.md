...
| **Patent publications** | Reported synthesis route, examples and publication chronology | Direct patent-document URLs below | **Amber** | Patent publication is evidence, not a blanket open-content or patent licence. Paraphrase route facts and independently redraw molecules/arrows. Do not copy figures or procedures; do not infer freedom to operate, validity or present patent status. |
...
| Separate chiral-route context | [EP0249610B1](https://patents.google.com/patent/EP0249610B1/en) | Amber | Separate, clearly titled route after expert review; never splice into the racemic route. |
...
| Early reported synthesis | [EP0005129A1](https://patents.google.com/patent/EP0005129A1/en) | Amber | Paraphrased historical route and independent redraw; not a protocol/FTO statement. |
| Omeprazole-specific reported synthesis | [US5386032A](https://patents.google.com/patent/US5386032A/en) | Amber | Same; keep route/source hierarchy. |
| Patent/form context | [US7326724B2](https://patents.google.com/patent/US7326724B2/en) | Amber | Context only where an exact claim requires it; no inferred present legal status. |
