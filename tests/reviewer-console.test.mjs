...
const record = {
  ...
  claimId: "claim:001",
  subjectId: "molecule:synthetic-fixture-alpha",
  subjectLabel: "Synthetic Compound Alpha",
  statement: "A source-located claim awaiting scientific review.",
  verificationStatus: "pending-review",
  evidenceLevel: "literature-reported",
  source: {
    sourceId: "source:synthetic-evidence-fixture:001",
    provider: "Synthetic evidence fixture",
    url: "https://evidence.example.invalid/document/synthetic-alpha",
    locator: "Synthetic fixture section A",
